...
def load_pretrained_model(
    ...
    device_map="auto", use_flash_attn=False, is_lora=False, **kwargs
):
    ...
    if 'llava' in model_name.lower() or 'baichuan' in model_name.lower() or 'llama' in model_name.lower():
        ...
        if is_lora and model_base is not None:
            ...
            assert 'mpt' not in model_name.lower(), 'mpt not supported!'
            ...
            assert 'mpt' not in model_name.lower(), 'mpt not supported!'
            assert 'mistral' not in model_name.lower(), 'mistral not supported!'
